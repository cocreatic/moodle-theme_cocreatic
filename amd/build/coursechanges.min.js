...
return this.trigger("hide"),s.apply(this,arguments)},d.on("hide",function(){console.log("SE OCULTó")});var l=t("<div></div>");l.append(d);var c={center:!0,modal:!0,visible:!1,draggable:!0,width:"auto",height:"auto",autofillheight:"header",bodyContent:l};if(n){if(n.indexOf("%")>=0){var h=t(window).width(),p=Number(n.replace("%",""));!isNaN(p)&&p>0&&(n=p*h/100)}c.width=n}if(r){if(r.indexOf("%")>=0){var f=t(window).height(),u=Number(r.replace("%",""));!isNaN(u)&&u>0&&(r=u*f/100)}c.height=r}var v=new M.core.dialogue(c);i.data("dialogue",v),v.after("visibleChange",function(t){"visible"===t.attrName&&t.prevVal&&!t.newVal&&d.contents().find("video, audio").each(function(){this.pause()})},v)}v.show()}))})}}});
