...
namespace theme_cocreatic\util;
...
class theme_settings {
    ...
    public function news_items() {
        ...
        for ($i = 1; $i <= $newscount; $i++) {
            ...
            if (!empty($theme->settings->$newscontent)) {
                $templatecontext['news'][$j]['content'] = theme_cocreatic_get_setting($newscontent, 'format_html');
            }
    ...
    public function logos_items() {
        ...
        for ($i = 1; $i <= $logoscount; $i++) {
            ...
            if (!empty($theme->settings->$logoscontent)) {
                $templatecontext['logos'][$j]['content'] = theme_cocreatic_get_setting($logoscontent, 'format_html');
            }
    ...
    public function stats_items() {
        ...
        for ($i = 1; $i <= $statscount; $i++) {
            ...
            if (!empty($theme->settings->$statscontent)) {
                $templatecontext['stats'][$j]['content'] = theme_cocreatic_get_setting($statscontent, 'format_html');
            }
    ...
    public function generalvars() {
        ...
        $templatecontext['wwwcurrenttheme'] = $CFG->wwwroot . '/theme/cocreatic';
