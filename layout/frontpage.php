...
if (isloggedin() && !isguestuser()) {
    ...
    echo $OUTPUT->render_from_template('theme_cocreatic/frontpage', $templatecontext);
} else {
    ...
    echo $OUTPUT->render_from_template('theme_cocreatic/frontpage_guest', $templatecontext);
}
